...
Several plots are available from the S3 method `plot` using the `probsup` object obtained from the `prob_sup` function. See `help(plot.probsup)` for more details. 
