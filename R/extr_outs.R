...
extr_outs = function(data, trait, model, probs = c(0.025, 0.975),
  ...
  # }
  #
  # variances$effect[which(variances$effect == 'l')] = "environment"
  # variances$effect[which(variances$effect == 'g')] = "genotype"
  # variances$effect[which(variances$effect == 'gl')] = "gen.env"
  ...
  if(verbose) message('2. Maximum posterior values extracted')
  ...
  if(verbose) message('3. Goodness-of-fit diagnostics computed')
  ...
  if(verbose) message('4. Function plots built')
  ...
  if(check.stan.diag){
    ...
    if(verbose) message('5. Stan diagnostic plots built')
