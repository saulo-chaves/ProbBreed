...
#include "stanExports_entrymean2.h"

RCPP_MODULE(stan_fit4entrymean2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_entrymean2")
